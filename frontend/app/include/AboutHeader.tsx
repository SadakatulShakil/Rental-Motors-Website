...
export default function HeroSection() {
  ...
  return (
    ...
    className="bg-yellow-500 text-black w-35 h-35 rounded-full text-xl font-bold hover:bg-yellow-600 transition shadow-lg flex items-center justify-center text-center leading-tight"
>
    Book <br/> Now
</button>
            </div>
